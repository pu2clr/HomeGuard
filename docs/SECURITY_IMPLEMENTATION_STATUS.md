...
scp scripts/setup-mqtt-security.sh pi@192.168.1.102:/home/pi/
...
scp pi@192.168.1.102:/etc/mosquitto/certs/ca.crt /etc/mosquitto/certs/
...
```bash
# Teste básico TLS
mosquitto_sub -h 192.168.1.102 -p 8883 --cafile /etc/mosquitto/certs/ca.crt \
    -u homeguard -P pu2clr123456 -t home/test -v

# Publicar mensagem teste
mosquitto_pub -h 192.168.1.102 -p 8883 --cafile /etc/mosquitto/certs/ca.crt \
...
openssl s_client -connect 192.168.1.102:8883 -CAfile /etc/mosquitto/certs/ca.crt
```
