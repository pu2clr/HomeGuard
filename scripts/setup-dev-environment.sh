...
show_usage_instructions() {
    ...
    echo "  1. Garagem        (IP: 192.168.1.201)"
    echo "  2. Área Serviço   (IP: 192.168.1.202)"
    echo "  3. Varanda        (IP: 192.168.1.203)"
    echo "  4. Mezanino       (IP: 192.168.1.204)"
    echo "  5. Ad-Hoc         (IP: 192.168.1.205)"
    echo ""
