...
print("- http://192.168.18.236:5000/sensors    (página principal)")
print("- http://192.168.18.236:5000/sensor     (alternativa)")  
print("- http://192.168.18.236:5000/sensor/    (redirecionamento)")
print("- http://192.168.18.236:5000/alerts     (página de alertas)")

print("\n🔧 URLs de API:")
print("- http://192.168.18.236:5000/api/sensors")
print("- http://192.168.18.236:5000/api/alerts")
