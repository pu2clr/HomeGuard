...
### MQTT Broker:
- **Host**: 192.168.18.236 (or your Pi's IP)
- **Port**: 1883
- **User**: homeguard
- **Pass**: pu2clr123456
...
- **Audio System**: 192.168.18.236 (Pi IP)
...
mosquitto_pub -h 192.168.18.236 -t home/audio/cmnd -m "DOGS" -u homeguard -P pu2clr123456
```
